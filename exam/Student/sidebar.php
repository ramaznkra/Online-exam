<?php
    ...
    if($_SESSION["loggedin"]==true && $_SESSION["second_id"]==1){
...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <!--Sidebar-->
        <div class="sidebar">
            <a href="index.php"><i class="fas fa-plus"></i><span>Nasıl Kullanılır</span></a>
            <a href="dashboard.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
            <a href="papers.php"><i class="far fa-sticky-note"></i><span>Sınavlar</span></a>
